    ...
    AddEventHandler('Zaaa:Impound', function ()
        ...
        if vehicle ~= nil then
            ...
            ------ Fungsi Untuk Cek Kendraan nya valid apa kga / spawn apa kga, aktifin aj klo di butuhin

            -- if owner == nil then
            --     DeleteVehicle(vehicle)
            --     lib.notify({title = 'Police', description = 'Kendraan Tidak Terdaftar', type = 'error'})
            --     return
